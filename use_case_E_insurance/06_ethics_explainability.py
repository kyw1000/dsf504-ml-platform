...
==============================================
DSF504 Use Case E — Insurance Risk Prediction
ML Framework Phase 6: Ethics, Bias Audit & Model Explainability

Outputs saved to reports/use_case_E/
Run:
    cd C:\\DSF504
    python use_case_E_insurance/06_ethics_explainability.py
"""
...
def main():
    log.info("Step 6: Ethics & Explainability — E — Insurance Risk Prediction")
    ...
    ax.set_title("Top 20 Feature Importance — E — Insurance Risk Prediction")
    plt.tight_layout()
    ...
    try:
        ...
        ax.set_title("Variability vs Importance — E — Insurance Risk Prediction")
        plt.tight_layout()
